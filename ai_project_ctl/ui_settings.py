...
ALLOW_REPORT_WARNINGS_SETTING = "allow_report_warnings"
ALLOW_RELAXED_REPORT_WARNINGS_SETTING = "allow_relaxed_report_warnings"
...
DEFAULT_UI_SETTINGS: dict[str, Any] = {
    ...
    ALLOW_RELAXED_REPORT_WARNINGS_SETTING: False,
}
