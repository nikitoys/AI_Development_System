...
OutputRunner = Callable[[Sequence[str]], subprocess.CompletedProcess[str]]
...
def run_codex_adapter(
    *,
    ...
    prompt_check = _validate_prompt(prompt_path, task_id, token_gate.prompt_sha256)
    if prompt_check:
...
def _validate_prompt(
    ...
    task_ids = {match.group("task") for match in PROMPT_TASK_RE.finditer(prompt_text[:8000])}
