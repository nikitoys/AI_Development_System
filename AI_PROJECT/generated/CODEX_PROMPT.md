...
```text
TASK-027 Task I - Add locking and atomic write protection Make parallel project-control operations safer. Add file locking and atomic write behavior for state, events, and generated outputs so concurrent operations cannot corrupt project-control files or leave partial writes. ai_project_ctl/core/locks.py Concurrent writes are guarded by locks and atomic replace semantics with readable errors. Add file lock support for state mutations. Use atomic write via temp file plus replace for protected outputs where appropriate. Return clear errors if another process is writing. Avoid partial writes to state/events/generated files. Add tests for lock contention and atomic write behavior. Do not introduce a database backend. Do not implement remote or multi-user server locking. Do not change lifecycle semantics. ai_project_ctl/core/locks.py ai_project_ctl/core/store.py ai_project_ctl/core/events.py ai_project_ctl/core/renderer.py tests/** AI_PROJECT/state/tasks.json via taskctl.py only AI_PROJECT/events/task-events.jsonl via taskctl.py only AI_PROJECT/generated/CODEX_TASKS.md via taskctl.py only AI_PROJECT/generated/TASK_EXECUTION_QUEUE.md via taskctl.py only Concurrent writes cannot corrupt state. Locking behavior is tested. Error messages are readable. State/events/generated writes avoid partial output. Verify lock implementation is cross-platform enough for the repository's expected local workflow. Verify tests cover contention and failure cleanup.
```

## Task Boundary Snapshot

Task: `TASK-027` - Task I - Add locking and atomic write protection
Status: `in_review`
...
| ---: | --- | --- | --- | --- | --- | --- |
| 133 | `ai-system/skills/README.md` | Skills Layer Roadmap > Existing Useful Skills | 34-43 | `dbf637225bec` | `758bde12e28c` | metadata token match: md; content token match: a, add, ai_project, and, avoid, behavior, by, change |
| 124 | `ai-system/project-control/04-command-catalog.md` | Project Control Command Catalog > Self-Hosted Command Boundary | 64-116 | `a1985ca2f321` | `b755c971df05` | metadata token match: md, project-control; content token match: a, ai_project, and, are, by, events, files, generated |
| 115 | `ai-system/project-control/03-state-model.md` | Project Control State Model > Context Control State | 104-125 | `b69e6c6ad9ac` | `0cd80bdf0d55` | heading token match: state; metadata token match: md, project-control, state; content token match: a, ai_project, and, are, by, events, file, files |
| 115 | `ai-system/project-control/06-prompt-package-spec.md` | 17. Relationship To taskctl.py And codexctl.py | 874-906 | `9304e03cf1dd` | `6cf68be89257` | heading token match: and, py, taskctl, to; metadata token match: and, md, project-control, py, taskctl, to; content token match: a, and, by, clear, events, for, generated, make |
| 110 | `ai-system/skills/README.md` | Skills Layer Roadmap > Recommended Skills To Create | 80-92 | `dbf637225bec` | `eef80c572381` | heading token match: to; metadata token match: md, to; content token match: a, and, events, files, for, generated, if, introduce |
| 101 | `ai-system/project-control/06-prompt-package-spec.md` | 3. Current Implementation | 123-162 | `9304e03cf1dd` | `4fe051d2de08` | heading token match: implementation; metadata token match: implementation, md, project-control; content token match: a, ai_project, and, are, behavior, clear, for, generated |
| 93 | `ai-system/project-control/03-state-model.md` | Project Control State Model > Self-Hosted State In AI_Development_System | 55-70 | `b69e6c6ad9ac` | `a3eb858c2904` | heading token match: state; metadata token match: md, project-control, state; content token match: ai_project, and, by, do, events, for, generated, if |
| 93 | `ai-system/project-control/03-state-model.md` | Project Control State Model > Documentation Control State | 71-103 | `b69e6c6ad9ac` | `c68c7fcfa12b` | heading token match: state; metadata token match: md, project-control, state; content token match: a, ai_project, and, are, by, events, files, for |
...
Reasons: metadata token match: md; content token match: a, add, ai_project, and, avoid, behavior, by, change
...
Reasons: metadata token match: md, project-control; content token match: a, ai_project, and, are, by, events, files, generated
...
Reasons: heading token match: state; metadata token match: md, project-control, state; content token match: a, ai_project, and, are, by, events, file, files
...
Reasons: heading token match: and, py, taskctl, to; metadata token match: and, md, project-control, py, taskctl, to; content token match: a, and, by, clear, events, for, generated, make
...
Reasons: heading token match: to; metadata token match: md, to; content token match: a, and, events, files, for, generated, if, introduce
...
Reasons: heading token match: implementation; metadata token match: implementation, md, project-control; content token match: a, ai_project, and, are, behavior, clear, for, generated
...
Title: Project Control State Model
Status: `active`  Type: `reference`
Heading: Project Control State Model > Self-Hosted State In AI_Development_System
Lines: `55-70`
Score: `93`
Content hash: `b69e6c6ad9acbaf0bb398fd6ad729bb07290b6138e99a3535701e57c750a244d`
Chunk hash: `a3eb858c29046d048741fee3ddae028c15ff698de46e52343deaa93ea48148d6`
Reasons: heading token match: state; metadata token match: md, project-control, state; content token match: ai_project, and, by, do, events, for, generated, if
...
Reasons: heading token match: state; metadata token match: md, project-control, state; content token match: a, ai_project, and, are, by, events, files, for
