...
```text
TASK-188 Document auto-close owner note workflow Project control docs must explain when and how the Human Owner supplies auto-close notes for pipeline runs. This updates operator guidance after the UI and CLI owner-note paths are explicit. AI_PROJECT/generated/CODEX_CURRENT.md Task completed according to acceptance criteria Document that auto-close policies require an explicit Human Owner auto-close note before execution. Add CLI examples for ui run and pipeline session create with auto-close notes. Add Web Control Center guidance for the selected-task run owner note field. Clarify that Codex must not invent or provide owner approval notes. Do not change runtime code. Do not change task lifecycle rules unrelated to pipeline auto-close. Do not edit protected project-control files manually. ai-system/project-control/pipeline-runner.md ai-system/project-control/10-owner-quickstart.md Docs state that auto-close owner notes are explicit Human Owner approval inputs. Docs include a current CLI example using --auto-close-note. Docs mention the Web Control Center selected-task run owner note field. Docs preserve the rule that Codex cannot approve, accept, or fabricate owner notes. Documentation changes are limited to the auto-close owner-note workflow. Check that documentation does not imply automatic final acceptance.
```

## Task Boundary Snapshot

Task: `TASK-188` - Document auto-close owner note workflow
Status: `in_progress`

Scope:
- Document that auto-close policies require an explicit Human Owner auto-close note before execution.
- Add CLI examples for ui run and pipeline session create with auto-close notes.
- Add Web Control Center guidance for the selected-task run owner note field.
- Clarify that Codex must not invent or provide owner approval notes.
...
| ---: | --- | --- | --- | --- | --- | --- |
| 146 | `ai-system/skills/README.md` | Skills Layer Roadmap > Recommended Skills To Create | 80-92 | `dbf637225bec` | `eef80c572381` | heading token match: create, to; metadata token match: ai-system, create, md, to; content token match: a, accept, acceptance, and, approval, automatic, before, changes |
| 124 | `ai-system/skills/README.md` | Skills Layer Roadmap > Existing Useful Skills | 34-43 | `dbf637225bec` | `758bde12e28c` | metadata token match: ai-system, md; content token match: a, acceptance, add, after, ai_project, and, approval, approve |
| 120 | `ai-system/project-control/03-state-model.md` | Project Control State Model > Context Control State | 104-125 | `9e818e514763` | `0cd80bdf0d55` | heading token match: control, project, state; metadata token match: ai-system, control, md, project, project-control, state; content token match: a, acceptance, ai_project, and, are, control, criteria, current |
| 120 | `ai-system/project-control/04-command-catalog.md` | Project Control Command Catalog > Self-Hosted Command Boundary | 65-119 | `f824429b0a39` | `5b78d4503548` | heading token match: control, project; metadata token match: ai-system, control, md, project, project-control; content token match: a, acceptance, ai-system, ai_project, and, are, cli, control |
| 107 | `ai-system/project-control/03-state-model.md` | Project Control State Model > Documentation Control State | 71-103 | `9e818e514763` | `c68c7fcfa12b` | heading token match: control, documentation, project, state; metadata token match: ai-system, control, documentation, md, project, project-control, state; content token match: a, ai_project, and, are, control, current, docs, document |
| 104 | `ai-system/project-control/04-command-catalog.md` | 18. Additional Command Domains > Pipeline Commands | 2294-2321 | `f824429b0a39` | `efe882b18c98` | heading token match: pipeline; metadata token match: ai-system, control, md, pipeline, project, project-control; content token match: acceptance, ai_project, and, approval, are, automatic, change, codex |
| 104 | `ai-system/project-control/06-prompt-package-spec.md` | 14. Context Budget Rules > Context Pack Boundary | 797-833 | `3444e8d40e40` | `24706f89c068` | heading token match: rules; metadata token match: ai-system, control, md, project, project-control, rules; content token match: a, acceptance, add, and, before, change, codex, criteria |
| 102 | `ai-system/project-control/04-command-catalog.md` | Project Control Command Catalog > Scope | 21-64 | `f824429b0a39` | `9c998142f16f` | heading token match: control, project; metadata token match: ai-system, control, md, project, project-control; content token match: a, add, and, center, change, codex, control, current |
...
Reasons: heading token match: create, to; metadata token match: ai-system, create, md, to; content token match: a, accept, acceptance, and, approval, automatic, before, changes
...
Reasons: metadata token match: ai-system, md; content token match: a, acceptance, add, after, ai_project, and, approval, approve
...
Reasons: heading token match: control, project, state; metadata token match: ai-system, control, md, project, project-control, state; content token match: a, acceptance, ai_project, and, are, control, criteria, current
...
Reasons: heading token match: control, project; metadata token match: ai-system, control, md, project, project-control; content token match: a, acceptance, ai-system, ai_project, and, are, cli, control
...
Reasons: heading token match: control, documentation, project, state; metadata token match: ai-system, control, documentation, md, project, project-control, state; content token match: a, ai_project, and, are, control, current, docs, document
...
Reasons: heading token match: pipeline; metadata token match: ai-system, control, md, pipeline, project, project-control; content token match: acceptance, ai_project, and, approval, are, automatic, change, codex
...
Reasons: heading token match: rules; metadata token match: ai-system, control, md, project, project-control, rules; content token match: a, acceptance, add, and, before, change, codex, criteria
...
Reasons: heading token match: control, project; metadata token match: ai-system, control, md, project, project-control; content token match: a, add, and, center, change, codex, control, current
